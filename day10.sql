...
/*
INSERT INTO "SCOTT"."EMP" (EMPNO, ENAME, JOB, MGR, HIREDATE, SAL) VALUES ('7777', 'JJ', 'CLERK', '7902', TO_DATE('2019-06-27 13:09:09', 'YYYY-MM-DD HH24:MI:SS'), '900')
INSERT INTO "SCOTT"."EMP" (EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, COMM) VALUES ('8888', 'J_JAMES', 'SALESMAN', '7698', TO_DATE('2019-06-07 13:10:37', 'YYYY-MM-DD HH24:MI:SS'), '1250', '200')
...
-- 그러려면 dept 테이블 쪽의 데이터가 NULL 이어도 추가 출력이 필요.
...
8888	J_JAMES	
*/
-- {+) 연산자는 오른쪽에 붙이고 이는 NULL 상태로 출력될 테이블을 결정짓는다.
...
-- RIGHT OUTER JOIB 연산자에 의해 오른쪽 테이블인 dept 테이블의
-- 데이터는 모두 출력을 보장받는다.
